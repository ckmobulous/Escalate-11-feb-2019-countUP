...
class SearchVC: UIViewController,AVAudioRecorderDelegate,AVAudioPlayerDelegate,UISearchBarDelegate{
    ...
    var recentSearchModelArray = [RecentSearchModel]()
    
    var tempsearchfilteredModelArray = [RecentSearchModel]()
...
//        AccessCurrentLocationuser()
            ...
            WebserviceConnection.requestPOSTURL("postlist/\(user_id)", params: Passdict as [String : AnyObject], headers:nil, success: { (responseJson) in
                ...
                if responseJson["status"].stringValue == "SUCCESS" {
                    ...
                    for item in self.dataArray {
                        ...
                        self.audioUrlArray.append(audio_url)
                        ...
                        let postItem = SavedPostsDataModel(user_id: user_id, user_image: user_image, fullname: fullname, username: username, audio_url: audio_url, description: description, topic_name: topic_name, duration: duration, post_id: post_id, like_flag: like_flag, like_count: like_count, reply_count: reply_count, tag_list: tag_list)
    ...
    @objc func btnShareTapped(sender: UIButton){
        ...
        let audioUrl = dataDict.audio_url ?? ""
    ...
    @objc func btnPlayPausedTapped(sender: UIButton){
        ...
        audioUrl = NSURL(string: dataDict.audio_url ?? "")! as URL
    ...
    @objc func btnOtherProfileTapped(sender: UIButton){
        ...
        if tag == 1{
            ...
            if searchActive == true{
                ...
                let recentSearchItem = RecentSearchModel(type: "people", search_name: fullname, follower_flag: follower_flag, fullname: fullname, number_of_post: number_of_post, topic_match: topic_match, user_id: user_id, user_image: user_image, user_name: user_name, tag_id: "", num_of_post: "", tag_name: "", icon: "")
                ...
                if recentSearchModelArray.isEmpty{
                    
                    self.recentSearchModelArray.append(recentSearchItem)
                    ...
                    if flag == false{
                        ...
                        self.recentSearchModelArray.insert(recentSearchItem, at: 0)
                ...
                recentSearchModelArray = recentSearchModelArray.sorted{$0.search_name! < $1.search_name!}
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        if tag == 1{
            ...
            var temArray = NSArray()
            
            print(recentArray)
            
            let dummyFilterArray = recentArray.mutableCopy() as? NSMutableArray ?? []
            
            print(dummyFilterArray)
            
            dummyFilterArray.removeAllObjects()
            
            filteredArray = recentArray.mutableCopy() as? NSArray ?? []
            
            print(filteredArray)
            
            filteredArray = (recentArray.filter({ (text) -> Bool in
                // fsa
                let tmp: NSString = text as! NSString
            ...
            for i in 0..<self.recentSearchModelArray.count {
                
                let temdict = self.recentSearchModelArray[i]
                
                let selectedname =  temdict.search_name ?? ""
                ...
                for j in 0..<self.filteredArray.count{
                    ...
                    if name  ==  selectedname {
                        ...
                        tempsearchfilteredModelArray.append(temdict)
            ...
            if tempsearchfilteredModelArray.count == 0 && searchBar.text == ""{
            ...
            tempsearchfilteredModelArray = tempsearchfilteredModelArray.sorted{$0.search_name! < $1.search_name!}
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if tag == 1{
            ...
            if searchActive == true {
                ...
                return recentSearchModelArray.count
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if tag == 2{
            ...
            if searchActive == true{
                ...
                let recentSearchItem = RecentSearchModel(type: "topic", search_name: tag_name, follower_flag: "", fullname: "", number_of_post: "", topic_match: "", user_id: "", user_image: "", user_name: "", tag_id: tag_id, num_of_post: num_of_post, tag_name: tag_name, icon: icon)
            ...
            if searchActive == true{
                ...
                let recentSearchItem = RecentSearchModel(type: "tag", search_name: tag_name, follower_flag: "", fullname: "", number_of_post: "", topic_match: "", user_id: "", user_image: "", user_name: "", tag_id: tag_id, num_of_post: num_of_post, tag_name: tag_name, icon: icon)
